...
async def on_message(message):
    ...
    if message.content == "おみくじ":
        ...
        embed.add_field(name="[総合運]", value=random.choice(("★★★★★", "★★★★☆", "★★★☆☆", "★★☆☆☆", "★☆☆☆☆")), inline=False)
        embed.add_field(name="[恋愛運]", value=random.choice(("★★★★★", "★★★★☆", "★★★☆☆", "★★☆☆☆", "★☆☆☆☆")), inline=False)
        embed.add_field(name="[金運]", value=random.choice(("★★★★★", "★★★★☆", "★★★☆☆", "★★☆☆☆", "★☆☆☆☆")), inline=False)
        embed.add_field(name="[健康運]", value=random.choice(("★★★★★", "★★★★☆", "★★★☆☆", "★★☆☆☆", "★☆☆☆☆")), inline=False)
        #メッセージは適当
